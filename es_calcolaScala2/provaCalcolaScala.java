...
public class provaCalcolaScala {
    public static void main(String[] args) {
        // array delle note
        String[] notes = {"C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"}; // scala cromatica

        // array degli intervalli per scale 
        ...
        System.out.println("Scegli una scala :");
        ...
        if (scalaScelta.equals("Ionian")) {
            IntervalloSelezionato = IntervalsIonianScale; // faccio corrispondere la scelta dell'utente alla scala
        } else if (scalaScelta.equals("Aeolian")) {
            IntervalloSelezionato = IntervalsAeolianScale; // faccio corrispondere la scelta dell'utente alla scala
        } else {
            System.out.println("Scelta non valida.");cd
            scanner.close();
            return;
        }
